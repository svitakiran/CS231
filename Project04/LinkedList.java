 ...
 * the Queue and Iterable interfaces.
 * Author: Svita Kiran
 * Date: 3/15/24
*/
...
public class LinkedList<T> implements Queue<T>, Iterable<T>{
    ...
    public E findMin(Comparator<E> comparator) {
        if (isEmpty()) {
            return null;
        }
        Node<E> current = head;
        E minItem = head.data;
        while (current != null) {
            if (comparator.compare(current.data, minItem) < 0) {
                minItem = current.data;
            }
    ...
    public E removeMin(Comparator<E> comparator) {
        if (isEmpty()) {
            return null;
        }
        Node<E> current = head;
